...
const SignupForm: React.FC = () => {
    ...
    const handleSendOtps = async () => {
        ...
        try {
            ...
            await axios.post("https://backend-bcxr.onrender.com/api/auth/signup/initiate", values);
            toast.dismiss();
    ...
    const handleFinalSubmit = async () => {
        ...
        try {
            ...
            const { data } = await axios.post("https://backend-bcxr.onrender.com/api/auth/signup/verify", {
                email,
                emailOtp,
